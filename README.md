...
- **Настройки расписания.** Reply-кнопка «⚙️ Настройки»: таймзона (из списка российских зон), начало и конец рабочего дня, длина слота. Параметры задают сетку времени при создании записей.
