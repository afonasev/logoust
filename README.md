...
- **Настройки расписания.** Reply-кнопка «⚙️ Настройки»: таймзона (из списка российских зон), начало и конец рабочего дня, длина слота, рабочие дни недели (мульти-тоггл Пн–Вс), напоминания клиентам (вкл/выкл и время). Параметры задают сетку времени при создании записей и набор рабочих дней для свободных окон.
